...
function buttonclick(score) {
    var statement_1 = ["I am group-oriented and desire to unite people based on common values",
    "I actively help others' feelings and resolve conflicts",
    "I acutely feel the general emotional atmosphere",
    "I pay attention to feelings and cater my speech to the community that I am part of",
    ...
    "I prefer expressing my feelings in indirect ways such as art or writing",
    "I am highly empathetic in a one-to-one manner, relating to my own feelings",
    "I live according to my deeply-felt values that are true to me",
    "I tend to have a hard time with objective standards and efficiency",
    "I primarily make my decisions based on my deep feelings, identity, and values",
    "I often feel ineffective and harshly criticize myself when I mess up",
    "I am often considered as a great brainstromer, generating loads of ideas",
    "I am the first to adopt new ideas and possibilities",
    "I dislike structure as it tends to restrict change and new possibilities",
    "I tend to fixate on my body or insignificant details when feeling depleted",
    "I can be forgetful with practical details and self-care due to my focus on new ideas",
    ...
    "I tend to overindulge in short-term pleasures when I can't seem to find a grand purpose",
    "I trust my own intuition in important decisions",
    "I maximize the pleasure of the moment",
    "I am prone to acting in the moment without thoroughly considering future consequences",
    "I have an out of sight, out of mind approach to life",
    "I generally stick with what I know and what has worked before based on past experience",
    "I familiarize myself with one thing for a long time and master it",
    ...
    "I contribute to others' feelings through my personal experience or insights",
    ...
    var statement_2 = ["I put a lot of focus on differentiating myself and being authentic",
    "I often go off-topic and connect unrelated concepts together",
    "I seek and harbor hidden symbolic meanings of things",
    "I readily adapt to the ever changing environment and focus on the moment",
    "I am prone to catastrophizing and ranting about negative possibilities",
    "I find practical, effective solutions to problems wherever I go",
    "I can be accidentally rude and miss social cues",
    "I have many interests which are often unrelated to each other",
    "I tend to be somewhat of a fortune teller with my future predictions",
    ...
    "I think being swayed by feelings hinder the ability to make effective decisions",
    "I am often disconnected from the emotional world and prone to apathy",
    "I am laser focused on how the far future will unfold",
    "I am the first to jump into new sensory experiences",
    "I follow the rules and make detailed plans in order to ensure things will go smoothly",
    "I define myself through my accomplishments as I am not very keen on exploring myself",
    "I am far more about the truth and how things work rather than being likable",
    "I dislike planning for the future as I prefer spontaneity",
    "I focus on practical details and building routines",
    "I am result-oriented and focus on getting things done as quickly as possible",
    "I make decisions based on my own logical frameworks",
    "I focus on self-care and sensory maintenance",
    "I hate wasting time, so I use my time as efficiently as possible",
    "I gather knowledge in order to tinker around with it",
    "I need to align my decisions with the objective facts and criteria",
    ...
    "I have a strong sense set of values which I adhere to at all costs",
    "I onten enjoy debating or persuading others through charisma",
    "I have a sense of quiet confidence and steadily pursue my goals",
    "I readily explore or experiment to find what makes logical sense to me",
    "I am often bold with my own logic, mentally or physically",
    "I am generally future-oriented and act readily to pursue my visions", // +
    "I determine the sensory experiences that suit me the best",
    "I mostly stick to the tried-and-true and prefer experimenting in more controlled environments", // + 
